...
public class RedisKeyUtil {
     ...
     * @return
     */
    public static String getStatusKeyByType(ItemTypeEnum type) {
    ...
    public static String getStatusKeyByType(Integer type) {
        ...
        } else if (type == ItemTypeEnum.COMMENT.getType()) {
    ...
    public static String getCountKeyByType(ItemTypeEnum type) {
